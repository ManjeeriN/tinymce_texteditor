...
//print_r($_SERVER['SERVER_NAME'].$_SERVER['PHP_SELF']);
...
//$base_url="http://".$_SERVER['HTTP_HOST'];  // DON'T TOUCH (base url (only domain) of site (without final /)).
 ...
 if($_SERVER['SERVER_NAME'] == "localhost"){
	$base_url = "http://localhost/text_editor/";
}
else if($_SERVER['SERVER_NAME'] == "server.com"){
	$base_url = "http://server.com/text_editor/";
}

//$base_url="http://dconsumeri.com/diffusion";
